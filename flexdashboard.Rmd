...
**Reference**: “The Instacart Online Grocery Shopping Dataset 2017”, Accessed from https://www.instacart.com/datasets/grocery-shopping-2017 on October 27, 2025.
...
### Figure 3: Distribution of Order Sizes {data-width=650}

```{r figure3, echo = FALSE}
instacart %>% 
  count(order_id, name = "items_per_order") %>% 
  ggplot(aes(x = items_per_order)) +
  geom_histogram(binwidth = 1, boundary = 0, color = "blue") +
  labs(
